...
- [linear algebra](https://github.com/mac999/LLM-RAG-Agent-Tutorial/blob/main/1-1.prepare/linear-algebra.pdf). [Matrix, tensor handling and visualization cheat sheet](https://github.com/mac999/LLM-RAG-Agent-Tutorial/blob/main/1-1.prepare/data-visualization(numpy%2C%20pandas%2C%20pytorch%2C%20tensor).pdf) 
